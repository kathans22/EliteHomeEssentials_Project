...
export class PlumbingComponent implements OnInit {
  focus: any;
  focus1: any;
  serviceTexts = ['Add Service', 'Add Service', 'Add Service', 'Add Service', 'Add Service', 'Add Service', 'Add Service', 'Add Service', 'Add Service', 'Add Service', 'Add Service', 'Add Service'];
